...
final class LaravelWalletProvider extends ServiceProvider implements DeferrableProvider
{
    /**
     * Bootstrap services.
     */
    ...
    {
        $this->mergeConfigFrom(dirname(__DIR__) . '..\vendor\laravel-wallet\config\config.php', 'wallet');
