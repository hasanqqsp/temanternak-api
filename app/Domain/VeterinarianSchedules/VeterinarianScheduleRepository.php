...
interface VeterinarianScheduleRepository
{
    ...
    public function getAvailableStartTimesForReschedule(string $bookingId, int $bufferTime, int $minGap);
    public function checkIfTimeIsAvailable(string $veterinarianId, DateTime $startTime, DateTime $endTime);
    public function checkIfTimeIsAvailableForReschedule(string $bookingId, DateTime $startTime);
}
